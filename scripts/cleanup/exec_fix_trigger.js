/**
 * 执行修复触发器SQL脚本
 * 此脚本连接到数据库并执行scripts/cleanup/fix_construction_acceptance_trigger.sql中的SQL命令
 * 用于修复引用已删除字段的触发器
 */
...
async function runSQLScript() {
  ...
  try {
    ...
    // 读取 SQL 脚本
    const sqlFilePath = path.join(__dirname, 'fix_construction_acceptance_trigger.sql');
