/**
 * 执行修复deleted_records表触发器的SQL脚本
 * 此脚本连接到数据库并执行scripts/cleanup/fix_deleted_records_triggers.sql中的SQL命令
 */
...
async function runSQLScript() {
  console.log('===================================');
  console.log('  修复deleted_records表触发器脚本');
  console.log('===================================\n');
  ...
  try {
    ...
    // 读取 SQL 脚本
    const sqlFilePath = path.join(__dirname, 'fix_deleted_records_triggers.sql');
